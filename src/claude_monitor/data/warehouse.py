...
class UsageWarehouse:
    ...
    def load(self) -> Dict[str, Any]:
        ...
        return {"schema_version": WAREHOUSE_SCHEMA_VERSION, "records": records}
    ...
    def upsert_entries(
        ...
        self._write_document(
            {"schema_version": WAREHOUSE_SCHEMA_VERSION, "records": records}
        )
    ...
    def _empty_document() -> Dict[str, Any]:
        return {"schema_version": WAREHOUSE_SCHEMA_VERSION, "records": []}
